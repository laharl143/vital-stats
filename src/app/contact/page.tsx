        ...
        <div className="px-8 md:px-16 py-10 grid grid-cols-1 md:grid-cols-3 gap-12"
          ...
          <div className="md:col-span-2 flex flex-col gap-6">
            ...
            <div className="p-6 rounded-[6px] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"
              style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.06)" }}>
              <div>
                <div className="text-[11px] font-medium tracking-[0.14em] uppercase mb-1" style={{ color: "var(--teal)" }}>
              ...
              <Link href="/book-consult"
                className="flex-shrink-0 text-white text-[11px] font-medium tracking-[0.08em] uppercase px-6 py-[11px] rounded-[2px] transition-opacity duration-200 hover:opacity-85"
                style={{ background: "var(--teal)" }}>
                Book a Consult →
              </Link>
            </div>
